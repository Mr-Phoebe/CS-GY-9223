...
MY_ACCESS_KEY_ID = 'AKIAJE4SY4WGNHFFU36A'
MY_SECRET_ACCESS_KEY = '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'
...
'''
id,name,address,reviewcnt,rate,price,phone,cuisine,score
...
def main():
    ...
    '''
    colunm_names = 'id,name,address,reviewcnt,rate,price,phone,cuisine,score'.split(',')
    table_name = 'Chat-Restaurant'
    csv_file_name = 'FILE_1.csv'
    column_types = [str, str, str, int, float, int, str, str, int]
